x.dom.on(window, 'load', function()
{
    x.require({
        files: [
            { fileType: 'css', id: 'x.ui.dialogs.css', path: x.ui.styles.dir() + 'x.ui.dialogs.css' },
        ],
        callback: function(context)
        {
            ...
            $("#test2_5").click(function()
            {
                x.ui.dialogs.newDialog({
                    ...
                    fns: function()
                    {
                        ...
                        $(".arrowLeft,#colseTipsLayer").appendTo("#" + x.ui.dialogs.newDialog.getID());
                        $("#" + x.ui.dialogs.newDialog.getID()).find(".boxContent").css({ background: "#FFFFFF" }).addClass("tipslayer");
                    }
                });
            });
            ...
            $("#test2_7").click(function()
            {
                x.ui.dialogs.newDialog({
                    ...
                    fns: function()
                    {
                        $("#" + x.ui.dialogs.newDialog.getID()).parent().animate({ "bottom": "0px" }, 500);
                    }
                });
            });
